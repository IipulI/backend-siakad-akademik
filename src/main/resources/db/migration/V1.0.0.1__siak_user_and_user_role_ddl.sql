...
CREATE INDEX IF NOT EXISTS idx_user_role_user_id ON public.siak_user_role(siak_user_id);
CREATE INDEX IF NOT EXISTS idx_user_role_role_id ON public.siak_user_role(siak_role_id);
