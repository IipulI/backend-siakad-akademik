...
public interface KelasKuliahService {
    ...
    Page<KelasKuliahResDto> search(String keyword, String periodeAkademik, UUID periodeAkademikId, String tahunKurikulum, String programStudi, String sistemKuliah, String dosen, Pageable pageable);
